-- Fix the RPC function to use 'redeem' which is the correct transaction_type
...
BEGIN
  ...
  BEGIN
    ...
    -- 3. THIRD: Create employee event with correct transaction_type
    INSERT INTO employee_events (
      ...
      'manager',
      'redeem'  -- Back to 'redeem' which is actually valid
    );
